			...
			<%@include file="/admin/admin_header.html" %>
				...
				<section class="page-hero">
					<div class="hero-content">
						<h1 class="hero-title">Verified <span>Vendors</span></h1>
					</div>
				...
				<div class="listing-container">
					<div class="listing-card">
						<% AdminDao dao=new AdminDao(); ArrayList<Vendor>vendorList=dao.viewAllVendor();
							...
							<%} else{%>
								<div class="text-center p-5">
									<i class="fas fa-store-slash mb-3" style="font-size: 3rem; color: #cbd5e1;"></i>
									<h3 style="color: #64748b;">No Vendors Registered Yet</h3>
								</div>
								<%} %>
					</div>
				</div>

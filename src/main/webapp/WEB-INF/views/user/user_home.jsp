        ...
        <%@ page import="com.geovendor.entity.*,java.util.*" %>
            ...
            <body>
                <% String email=(String) session.getAttribute("sessionEmail"); String role=(String)
                    session.getAttribute("role"); if (email==null || session.isNew()) {
                    ...
                    if(role.equalsIgnoreCase("user")){ User u=(User) request.getAttribute("user"); String
                    ...
                    <%@ include file="/WEB-INF/views/user/user_header.html" %>
                        ...
                        <div class="actions-section">
                            ...
                            <div class="actions-grid">
                                <a href="/user/map" class="action-btn">
                                    <i class="fas fa-map"></i> Explore Vendors
                                </a>
                                <a href="/user/edit" class="action-btn">
                                    <i class="fas fa-user-edit"></i> Edit Profile
                                </a>
                                <a href="/user/feedback" class="action-btn">

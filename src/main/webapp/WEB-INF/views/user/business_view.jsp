<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ page import="com.geovendor.entity.*,java.util.*" %>
        ...
        <body>
            ...
            <% //=====SESSION CHECK=====String userEmail=(String) session.getAttribute("sessionEmail"); if
                (userEmail==null || session.isNew()) { request.setAttribute("message", "Please Login to Continue" );
                RequestDispatcher rd=request.getRequestDispatcher("/user/user_login.jsp"); rd.forward(request,
                response); return; } //=====USER DATA=====User u=(User) request.getAttribute("user"); String
                uploadPath=request.getContextPath(); String imagePath=uploadPath + "/" + (u !=null && u.getProfile_pic()
                !=null ? u.getProfile_pic() : "images/default.png" ); %>

                <!-- ===== HEADER INCLUDE ===== -->
                <%@ include file="/WEB-INF/views/user/user_header.html" %>

                    <% //=====BUSINESS FETCH=====String businessEmail=request.getParameter("email"); if
                        (businessEmail==null || businessEmail.isEmpty()) { businessEmail=userEmail; } Business
                        bs=(Business) request.getAttribute("business"); %>

                        <% if (bs !=null) { String businessImagePath=uploadPath + "/" + (bs.getBusiness_photo() !=null ?
                            bs.getBusiness_photo() : "images/default_business.png" ); %>
                            ...
                            <section class="biz-hero">
                                <div class="biz-hero-content">
                                    ...
                                    <p class="biz-category">
                                        <%= bs.getBusiness_category() !=null ? bs.getBusiness_category()
                                            : "Local Business" %>
                                    </p>
                                </div>
                            </section>

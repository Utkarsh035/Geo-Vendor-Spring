            ...
            <% String mess=(String) request.getAttribute("mess"); if (mess !=null) { %>
                ...
                <% } %>
                    ...
                    <% String email=(String) session.getAttribute("sessionEmail"); if(email==null || session.isNew()){
                        ...
                        rd=request.getRequestDispatcher("/vendor/vendor_login.jsp"); rd.forward(request, response);
                        return; // ✅ THIS IS THE KEY } Vendor v=(Vendor) request.getAttribute("vendor"); String
                        ...
                        <%@include file="/WEB-INF/views/vendor/vendor_header.html" %>
                            ...
                            <form method="POST" onsubmit="return checkValue()" action="/vendor/location/add">

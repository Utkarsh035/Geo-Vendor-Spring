            ...
            <%@include file="/WEB-INF/views/admin/admin_header.html" %>
                ...
                <section class="page-hero">
                    <div class="hero-content">
                        <h1 class="hero-title">Vendor <span>Feedback</span></h1>
                    </div>
                    <img alt="pin-img" src="/images/pin.gif" height="40" width="50" class="pin-img">
                </section>

                <div class="feedback-container">
                    <% AdminDao dao=new AdminDao(); ArrayList<Vendor_feedback>vfeedbacklist=dao.viewvendorFeedback();
                        if(vfeedbacklist.size()>0){
                        %>
                        <div class="feedback-grid">
                            <%for(Vendor_feedback vf:vfeedbacklist) { String rt=vf.getRating();
                                String[]rate=rt.split(","); %>
                                <div class="feedback-card">
                                    <div class="author-info">
                                        <div class="author-avatar">
                                            <%=vf.getName().substring(0, 1).toUpperCase() %>
                                        </div>
